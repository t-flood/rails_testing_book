...
RSpec.describe Project do
  ...
  describe "with a task" do
    ...
    it "marks a project done if it has no incomplete tasks" do
      task.mark_completed
      expect(project).to be_done
    end
  end
  ...
  describe "estimates" do
    ...
    it "can calculate total size" do expect(project).to be_of_size(10) expect(project).not_to be_of_size(5)
    end
